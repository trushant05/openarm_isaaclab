...
from .openarm_playground_marl_env_cfg import OpenarmPlaygroundMarlEnvCfg


class OpenarmPlaygroundMarlEnv(DirectMARLEnv):
    cfg: OpenarmPlaygroundMarlEnvCfg

    def __init__(self, cfg: OpenarmPlaygroundMarlEnvCfg, render_mode: str | None = None, **kwargs):
