...
optional arguments:
  ...
  --collision-approximation The method to use for collision approximation. (default: "convex decomposition")
...
def none_or_float(value):
    """Custom argparse type to parse a value that can be either 'none' or a float."""
    if value.lower() == "none":
        return None
    try:
        return float(value)
...
parser.add_argument(
    ...
    default="link0",
    help=(
        'Enter base link of your robot where articulation root needs to be initialized'
    ),
)
